...
module config_block #(
    ...
    localparam INIT             = 3'b000,   // Starea initiala de reset/pregatire
               ...
               FRAME_DONE       = 3'b110,   // Asteptare semnal frame_done de la rasterizator
               READING_FRAME    = 3'b111;   // Calcul unghi nou pentru urmatorul cadru
    ...
    always @(*) begin
        case (state)
            ...
            FRAME_DONE:     next_state = (frame_done && sw[3] == 1'b0) ? READING_FRAME : FRAME_DONE;        
