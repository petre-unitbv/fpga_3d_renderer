...
module bresenham #(
    ...
    localparam IDLE       = 3'b000,     // Asteapta semnalul de start
               ...
               DONE_STEP  = 3'b101;     // Semnalizeaza finalizarea
    ...
    always @(*) begin
        case (state)
            ...
            DRAW_STEP:  next_state = draw_end ? DONE_STEP : DRAW_PIXEL;     // Actualizare Bresenham
            DONE_STEP:  next_state = IDLE;                                  // Linie finalizata
