...
// Modul      : vertex_processor
// Autor      : Petru-Andrei BRASOVEANU  
// An         : 2026
//---------------------------------------------------------------
// Descriere  : Unitate de procesare a vertex-urilor (vertex processor) pentru pipeline grafic FPGA.
//              Executa secvential transformarile geometrice fundamentale: rotatie 3D, proiectie
//              perspectiva si mapare pe coordonate de ecran (NDC -> screen space).
//
//              Utilizeaza reprezentare numerica in virgula fixa semnata pentru a
//              permite implementarea hardware determinista fara unitati floating-point.
//
//              Arhitectura este FSM pipeline controlat, care orchestreaza submodule dedicate
//              pentru fiecare etapa de procesare, asigurand sincronizare intre calculele de
//              transformare geometrica si propagarea rezultatelor.
//
//              Include mecanisme de detectie overflow pentru fiecare etapa, utile in debugging
